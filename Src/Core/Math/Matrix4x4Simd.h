...
namespace RioCore
{
	RIO_ALIGN_DECL_16(struct) Matrix4x4Simd
	{
		simd128_t col[4];
	};

	RIO_SIMD_FORCE_INLINE simd128_t simd_mul_xyz1(simd128_t _a, const Matrix4x4Simd* _b)
	{
	...
	RIO_SIMD_FORCE_INLINE simd128_t simd_mul(simd128_t _a, const Matrix4x4Simd* _b)
	{
		const simd128_t xxxx = simd_swiz_xxxx(_a);
		const simd128_t yyyy = simd_swiz_yyyy(_a);
		const simd128_t zzzz = simd_swiz_zzzz(_a);
	...
	RIO_SIMD_INLINE void float4x4_mul(Matrix4x4Simd* __restrict _result, const Matrix4x4Simd* __restrict _a, const Matrix4x4Simd* __restrict _b)
	{
	...
	RIO_SIMD_FORCE_INLINE void float4x4_transpose(Matrix4x4Simd* __restrict _result, const Matrix4x4Simd* __restrict _mtx)
	{
	...
	RIO_SIMD_INLINE void float4x4_inverse(Matrix4x4Simd* __restrict _result, const Matrix4x4Simd* __restrict _a)
	{
