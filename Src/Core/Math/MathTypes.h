...
namespace RioCore
{
	...
	const Matrix3x3 MATRIX3X3_ZERO = { VECTOR3_ZERO, VECTOR3_ZERO, VECTOR3_ZERO };
	const Matrix4x4 MATRIX4X4_ZERO = { VECTOR4_ZERO, VECTOR4_ZERO, VECTOR4_ZERO, VECTOR4_ZERO };
