...
namespace RioCore
{
	...
	RIO_SIMD_INLINE Ty simd_shuf_xAzC_ni(Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_shuf_yBwD_ni(Ty _a, Ty _b)
	{
		const Ty xAyB   = simd_shuf_xAyB(_a, _b);
		const Ty zCwD   = simd_shuf_zCwD(_a, _b);
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_madd_ni(Ty _a, Ty _b, Ty _c)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_nmsub_ni(Ty _a, Ty _b, Ty _c)
	{
		const Ty mul    = simd_mul(_a, _b);
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_div_nr_ni(Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_rcp_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_orx_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_orc_ni(Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_neg_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_selb_ni(Ty _mask, Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_sels_ni(Ty _test, Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_not_ni(Ty _a)
	{
		const Ty mffff  = simd_isplat<Ty>(UINT32_MAX);
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_min_ni(Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_max_ni(Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_abs_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_imin_ni(Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_imax_ni(Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_clamp_ni(Ty _a, Ty _min, Ty _max)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_lerp_ni(Ty _a, Ty _b, Ty _s)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_sqrt_nr_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_sqrt_nr1_ni(Ty _a)
	{
		const Ty half = simd_splat<Ty>(0.5f);
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_rsqrt_ni(Ty _a)
	{
		const Ty one    = simd_splat<Ty>(1.0f);
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_rsqrt_nr_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_rsqrt_carmack_ni(Ty _a)
	{
		const Ty half    = simd_splat<Ty>(0.5f);
	...
	{
		template<typename Ty>
		RIO_SIMD_INLINE Ty simd_poly1(Ty _a, float _b, float _c)
		{
		...
		template<typename Ty>
		RIO_SIMD_INLINE Ty simd_poly2(Ty _a, float _b, float _c, float _d)
		{
			const Ty bbbb   = simd_splat<Ty>(_b);
		...
		template<typename Ty>
		RIO_SIMD_INLINE Ty simd_poly3(Ty _a, float _b, float _c, float _d, float _e)
		{
			const Ty bbbb   = simd_splat<Ty>(_b);
		...
		template<typename Ty>
		RIO_SIMD_INLINE Ty simd_poly4(Ty _a, float _b, float _c, float _d, float _e, float _f)
		{
			const Ty bbbb   = simd_splat<Ty>(_b);
		...
		template<typename Ty>
		RIO_SIMD_INLINE Ty simd_poly5(Ty _a, float _b, float _c, float _d, float _e, float _f, float _g)
		{
			const Ty bbbb   = simd_splat<Ty>(_b);
		...
		template<typename Ty>
		RIO_SIMD_INLINE Ty simd_logpoly(Ty _a)
		{
#if 1
		...
		template<typename Ty>
		RIO_SIMD_INLINE Ty simd_exppoly(Ty _a)
		{
#if 1
			const Ty result = simd_poly5(_a
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_log2_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_exp2_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_pow_ni(Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_dot3_ni(Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_cross3_ni(Ty _a, Ty _b)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_normalize3_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_dot_ni(Ty _a, Ty _b)
	{
		const Ty xyzw   = simd_mul(_a, _b);
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_ceil_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE Ty simd_floor_ni(Ty _a)
	{
		const Ty tmp0   = simd_ftoi(_a);
		const Ty tmp1   = simd_itof(tmp0);
	...
	template<typename Ty>
	RIO_SIMD_FORCE_INLINE Ty simd_round_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE bool simd_test_any_ni(Ty _a)
	{
	...
	template<typename Ty>
	RIO_SIMD_INLINE bool simd_test_all_ni(Ty _a)
	{
